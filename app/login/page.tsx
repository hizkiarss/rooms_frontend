...
import ForgetPasswordPopup from "@/app/login/components/ForgetPasswordPopup";
...
const Page = () => {
        ...
        const [forgetPasswordPopUp, setForgetPasswordPopUp] = useState<boolean>(false);
        const initialValues = {
            email: "",
            password: "",
        };
                ...
                <div className="block md:grid md:grid-cols-2 md:gap-10">
                    ...
                    <div
                        ...
                        <Formik
                            ...
                            <Form>
                                <div>
                                    <h2 className="font-semibold text-3xl md:text-6xl mb-5 md:mb-10">
                                        Welcome back.
                                    </h2>
                                    ...
                                    <div className="flex flex-col gap-1 mt-3 md:mt-6">
                                        ...
                                        <button onClick={() => setForgetPasswordPopUp(true)}
                                                className="text-end font-semibold mt-1 text-xs md:text-sm"
                                                type={"button"}>
                                            Forgot password?
                                        </button>
                                        <ForgetPasswordPopup isOpen={forgetPasswordPopUp}
                                ...
                                {isLoading ? <LoadingAnimation/>
                                    : <Buttons
                                        value="Sign in"
                                        className="w-full font-semibold border-2 rounded-md text-sm md:text-xl mt-8 md:mt-5  hover:!border-greenr"
                                        type="submit"
                                        disabled={isLoading}
                                    />}
                        ...
                        <p className="font-semibold text-xs md:text-base text-center mt-[3px] md:mt-2">
                            or
                        </p>
                        <button
                        ...
                        <div className="flex gap-1 items-center mt-4 text-sm justify-end z-10">
                            <p className={"mt-1"}>Don&apos;t have an account?</p>
                            <button onClick={()=> router.push('/register')} className={"font-semibold p-1 rounded-lg hover:bg-greenr hover:text-white  transition duration-200"}>Sign Up</button>
                        </div>
