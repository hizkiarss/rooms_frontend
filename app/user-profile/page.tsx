...
const Page = () => {
  ...
  const {
    ...
    error,
    isError,
  } = useFindUserbyEmail("user@gmail.com");
      ...
      <div className="grid grid-cols-4 px-[130px] gap-4 mt-10 mb-20">
        <div className="col-span-1">
          <div className="flex items-center ml-1 mb-4">
            <div>
              <h2 className="text-3xl font-semibold text-greenr max-w-fit">
                Hi, {user?.username || "User"}
              </h2>
              <p className="text-gray-500 max-w-fit">
            ...
            <div
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-sm pr-2">
                    Look back at your transactions in the past
                  </p>
                </div>
              </div>
              <ChevronRight className="size-10 h-fit" />
