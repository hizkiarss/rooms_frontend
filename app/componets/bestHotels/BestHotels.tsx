...
const BestDeals = () => {
    ...
    const getRatingString = (rating: number | null | undefined): string => {
        if (rating === null || rating === undefined) return "0";
        return rating.toString();
    };

    if (isLoading) return <div className={"flex items-center justify-center w-full h-[200px] md:h-[400px] "}>
                                            ...
                                            <div className={"mt-5 flex gap-2 items-center mb-4"}>
                                                <div
                                                    ...
                                                    <p className={"text-sm font-semibold"}>
                                                        {room.properties.averageRating ?? "N/A"}
                                                    </p>
                                                </div>
                                                <p className={"font-semibold"}>
                                                    {getRateLabel(getRatingString(room.properties.averageRating))}
