    ...
    return (
        <div>
            <div
                ...
                {isError && <ErrorHandler message={error?.message || 'An unexpected error occurred.'}  isOpen={showErrorPopUp} onClose={handleCloseErrorPopup}/>}
                ...
                <div className={"bg-white p-10 rounded-xl h-1/2 w-1/3 "}>
                    ...
                    <p className={"mb-8 text-sm text-slate-500"}>Fill this field with correct information to reset your
                        password</p>
                    <Formik
                    ...
                    >
                        {({errors, touched, isSubmitting}) => (
                            <Form>
                                ...
                                <div className={"flex flex-col mb-4 text-[15px]"}>
                                    <label className={"font-semibold mb-1"} htmlFor="newPassword">New Password</label>
