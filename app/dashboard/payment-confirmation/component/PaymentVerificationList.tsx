                                            ...
                                            <div className="flex-1 p-4 sm:p-6 space-y-1 sm:space-y-2 w-full sm:w-auto">
                                                <div className="flex items-center space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div
                                                            className="sm:hidden flex justify-between text-sm text-gray-500 mt-1 w-full">
                                      ...
                                      maximumFractionDigits: 0,
                                            ...
                                            <div className="p-4 sm:p-6 w-full sm:w-auto">
                                                <Dialog>
                                                    ...
                                                    <DialogContent
                                                        className="px-5 sm:px-10 h-3/5 overflow-scroll md:px-20">
                                                        <DialogHeader>
                                                                ...
                                                                <div className="mt-4 flex justify-between">
                                                                    <AlertDialog>
                                                                        <AlertDialogTrigger asChild>
                                                                            <Button
                                                                                className="flex-1 mr-2 border border-greenr text-greenr bg-transparent hover:bg-greenr hover:text-white">
                                                                                <Check
                                                                    ...
                                                                    <AlertDialog>
                                                                        <AlertDialogTrigger asChild>
                                                                            <Button
                                                                                className="flex-1 ml-2 border border-red-600 text-red-600 bg-transparent hover:bg-red-600 hover:text-white">
