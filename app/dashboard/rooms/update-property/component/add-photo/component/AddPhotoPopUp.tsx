...
const UpdatePropertyAddPhotoPopUp: React.FC = () => {
    ...
    return (
        <div>
            <NotificationPopUp title={"An Error Occured"} content={"Please try again later."} isOpen={errorPopUp}
                               onClose={() => setErrorPopUp(false)}/>
            <Dialog open={isDialogOpen} onOpenChange={handleDialogOpenChange}>
                <DialogTrigger asChild>
                    <Buttons value={"Upload Pictures"} className={"!text-xs md:!text-base  w-fit md:w-48  "}/>
                </DialogTrigger>
