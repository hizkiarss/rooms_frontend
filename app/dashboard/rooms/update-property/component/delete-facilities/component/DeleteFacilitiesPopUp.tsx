        ...
        <div>
            <AlertDialog>
                <AlertDialogTrigger asChild>
                    <Buttons value={"Delete facilities"}/>
                </AlertDialogTrigger>
                <AlertDialogContent className="max-w-3xl max-h-fit px-10 py-10">
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <div className={"text-black"}>
                                <AlertDialogTitle className={"text-2xl mb-6"}>Delete Facilities
                                    <p className={"text-base text-gray-400 font-medium"}> Remove These Facilities and Keep Your Listing Fresh</p>
                                </AlertDialogTitle>
                    ...
                    <AlertDialogFooter>
                        <AlertDialogAction className="px-0 hover:none !border-none !hover:border-none"
