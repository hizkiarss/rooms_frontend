    ...
    <div className="px-5 sm:px-10 md:px-20 lg:px-[80px] pb-[60px] pt-8 bg-[#F3F8FA]">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-4">
        {data &&
          ...
          pagedData.properties.map(
            (propertyItem: PropertyProjection, index) => (
              <div key={index}>
                <AnimationWrapper
                  y={40}
                    ...
                    <Carousel className="lg:col-span-1 col-span-1">
                      ...
                      <CarouselContent>
                        {propertyItem.property.propertyPictures.length > 0 ? (
                          propertyItem.property.propertyPictures.map(
                            (picture) => (
                    ...
                    <div className="col-span-1 py-4 ml-4 flex flex-col">
                      ...
                      <div className="flex gap-2 items-center mt-3">
                        <div className="bg-greenr text-white rounded-sm p-1 px-2">
                          <p className="text-sm">
                            <span className="font-semibold text-lg">
                              {propertyItem.property.averageRating.toString() ||
                                0}
                            </span>
                            /10
                          </p>
                        ...
                        <div className="flex mt-[3px] gap-1 text-[14px]">
                          ...
                          <p className="mt-[1px]">
                            {propertyItem.property.totalReview} review
                          </p>
                        </div>
                      </div>
                      ...
                      <Carousel className="border-t border-slate-500 pt-4 mt-4 text-[15px]">
                        ...
                        <CarouselNext
                          className={
                            "right-1 mt-2 disabled:hidden shadow-custom2"
                          }
                        />
                      </Carousel>
