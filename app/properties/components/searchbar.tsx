            ...
            {isAtTop ? (
                <div className="flex justify-end pr-4 mb-10 ">
                    <div className="w-fit shadow-lg flex border-t border-slate-300 rounded-b-xl bg-white items-center">
                        <button
                            className="flex gap-2 items-center px-4 py-3 text-[#007989] rounded-bl-xl text-base font-semibold bg-white transition-colors duration-300 ease-out hover:text-greenr hover:bg-white hover:border-2 hover:border-[#007989]">
                            <Filter size={18}/>
                            Filter
                        </button>
                        <Minus className="rotate-90 text-greenr" strokeWidth="1" size={32}/>
                        <button
                            className="flex gap-2 items-center px-4 py-3 text-[#007989] rounded-br-xl text-base font-semibold bg-white transition-colors duration-300 ease-out hover:text-greenr hover:bg-white hover:border-2 hover:border-[#007989]">
                            <ArrowDownAZ size={18}/>
                            Sort
                        </button>
                    </div>
                ...
                <div className="flex gap-4 justify-between items-center px-4 mb-6 mt-3 bg-slate-100 rounded-xl py-5 ">
                    <p className="font-semibold">Showing {searchInput.totalProperties} results</p>
                    <div className="flex gap-2">
                        <button
                            className="flex gap-2 items-center px-4 py-2 bg-[#007989] border-0 rounded-sm text-sm font-semibold text-white transition-colors duration-300 ease-out hover:text-greenr hover:bg-white hover:border-2 hover:border-[#007989]">
                            <Filter size={18}/>
                            Filter
                        </button>
                        <button
